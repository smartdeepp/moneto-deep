...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOST', default=['*'] if DEBUG else [])
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "apps.main.context_processors.globalContext",
            ],
        },
    },
]
...
if AWS_STORAGE_BUCKET_NAME:
    ...
    # STORAGES = {
    #     "staticfiles": {"BACKEND": "dcycle.storage_backends.StaticStorage"},
    #     "default": {"BACKEND": "dcycle.storage_backends.MediaStorage"}
    # }
...
if env.str('EMAIL_HOST_USER', default=''):
